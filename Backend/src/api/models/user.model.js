 ...
 * @property {mongoose.ObjectId} contratoId - Referencia al contrato asociado al usuario.
...
const userSchema = new mongoose.Schema(
  {
    ...
    contratoId: { type: mongoose.Schema.Types.ObjectId, ref: 'Contrato', default: null },
