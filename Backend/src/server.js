 ...
 * Se añade un pequeño delay de 2 segundos para permitir la conexión inicial de la DB.
 */
(async () => {
  try {
    // 🔹 Espera prudencial para que el loader de mongoose se conecte
    ...
    // El servidor sigue vivo aunque esto falle, permitiendo reintentos manuales o automáticos
    console.log("💡 Nota: Verifique que MongoDB esté corriendo para completar estos procesos.");
  }
})();